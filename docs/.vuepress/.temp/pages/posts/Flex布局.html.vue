<template><div><h2 id="flex布局" tabindex="-1"><a class="header-anchor" href="#flex布局" aria-hidden="true">#</a> Flex布局</h2>
<h3 id="_1-1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-1-介绍" aria-hidden="true">#</a> 1.1 介绍</h3>
<p>全称： Flex 是 Flexible Box 的缩写，意为&quot;弹性布局&quot;</p>
<p><img src="https://www.ruanyifeng.com/blogimg/asset/2015/bg2015071004.png" alt="img"></p>
<blockquote>
<p>容器默认存在两根轴：水平的主轴（main axis）和垂直的交叉轴（cross axis）。主轴的开始位置（与边框的交叉点）叫做<code v-pre>main start</code>，结束位置叫做<code v-pre>main end</code>；交叉轴的开始位置叫做<code v-pre>cross start</code>，结束位置叫做<code v-pre>cross end</code>。项目默认沿主轴排列。单个项目占据的主轴空间叫做<code v-pre>main size</code>，占据的交叉轴空间叫做<code v-pre>cross size</code>。</p>
</blockquote>
<h3 id="_1-2-容器的属性" tabindex="-1"><a class="header-anchor" href="#_1-2-容器的属性" aria-hidden="true">#</a> 1.2  容器的属性</h3>
...
<p>row（默认值）：主轴为水平方向，起点在左端。 左</p>
<p>row-reverse：主轴为水平方向，起点在右端。右
column：主轴为垂直方向，起点在上沿。下
column-reverse：主轴为垂直方向，起点在下沿。上对齐</p>
</blockquote>
</li>
<li>
<p>flex-wrap  是否换行</p>
...
<p>nowrap:  不换行</p>
<p>wrap: 换行</p>
<p>wrap-reverse: 逆向换行</p>
</blockquote>
</li>
<li>
<p>justify-content属性  元素的对齐方式</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.box</span> <span class="token punctuation">{</span>
